...
namespace TheTask_10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                Console.Write("введите трехзначное число: "); // читаю ввод пользователя
                int NNN = Convert.ToInt32(Console.ReadLine()); // конвертирую введенный текст в целое число 
                ...
                Console.WriteLine($"вторая цифра введенного числа, это: {N}"); // вывожу отформатированный текст в консоль
                Console.WriteLine(); // вывожу пустую строку для отсутпа  
